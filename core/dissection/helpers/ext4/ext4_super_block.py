...
from dissection.helpers.ext4.ext4_constants import Ext4State
from dissection.helpers.ext4.ext4_constants import Ext4Error
from dissection.helpers.ext4.ext4_constants import Ext4OS
from dissection.helpers.ext4.ext4_constants import Ext4Rev
from dissection.helpers.ext4.ext4_constants import Ext4Compat
from dissection.helpers.ext4.ext4_constants import Ext4Incompat
from dissection.helpers.ext4.ext4_constants import Ext4ReadOnlyCompat
# =============================================================================
#  GLOBALS / CONFIG
# =============================================================================
...
class Ext4SuperBlock(object):
    ...
    def inodes_count(self):
        return self._sb.s_inodes_count
    ##
    ## @brief      { function_description }
    ##
    ## @return     { description_of_the_return_value }
    ...
    def free_inodes_count(self):
        return self._sb.s_free_inodes_count
    ##
    ## @brief      { function_description }
    ##
    ## @return     { description_of_the_return_value }
    ...
    def first_data_block(self):
        return self._sb.s_first_data_block
    ##
    ## @brief      { function_description }
    ##
    ## @return     { description_of_the_return_value }
    ##
    @trace()
    def log_block_size(self):
        return self._sb.s_log_block_size
    ##
    ## @brief      { function_description }
    ##
    ## @return     { description_of_the_return_value }
    ##
    @trace()
    def log_cluster_size(self):
        return self._sb.s_log_cluster_size
    ##
    ## @brief      { function_description }
    ##
    ## @return     { description_of_the_return_value }
    ...
    def blocks_per_group(self):
        return self._sb.s_blocks_per_group
    ##
    ## @brief      { function_description }
    ##
    ## @return     { description_of_the_return_value }
    ##
    @trace()
    def clusters_per_group(self):
        return self._sb.s_clusters_per_group
    ##
    ## @brief      { function_description }
    ##
    ## @return     { description_of_the_return_value }
    ...
    def inodes_per_group(self):
        return self._sb.s_inodes_per_group
    ##
    ## @brief      { function_description }
    ##
    ## @return     { description_of_the_return_value }
    ...
    ##
    @trace()
    def max_mnt_count(self):
        return self._sb.s_max_mnt_count
    ##
    ## @brief      { function_description }
    ##
    ## @return     { description_of_the_return_value }
    ...
    ##
    @trace()
    def minor_rev_level(self):
        return self._sb.s_minor_rev_level
    ##
    ## @brief      { function_description }
    ##
    ## @return     { description_of_the_return_value }
    ...
    def checkinterval(self):
        return self._sb.s_checkinterval
    ##
    ## @brief      { function_description }
    ##
    ## @return     { description_of_the_return_value }
    ...
    ##
    def inode_size(self):
        return self._sb.s_inode_size
    ##
    ## @brief      { function_description }
    ##
    ## @return     { description_of_the_return_value }
    ##
    def block_group_nr(self):
        return self._sb.s_block_group_nr
    ##
    ## @brief      { function_description }
    ##
    ## @return     { description_of_the_return_value }
    ...
    def volume_name(self):
        return self._sb.s_volume_name
    ##
    ## @brief      { function_description }
    ##
    ## @return     { description_of_the_return_value }
    ##
    def last_mounted(self):
        return self._sb.s_last_mounted
    ##
    ## @brief      { function_description }
    ##
    ## @return     { description_of_the_return_value }
    ##
    def algorithm_usage_bitmap(self):
        return self._sb.s_algorithm_usage_bitmap
